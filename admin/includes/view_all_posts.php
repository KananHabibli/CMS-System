...
<form action="" method="post">
    ...
    <?php
        ...
        // echo "<td><img class= 'img-responsive' scr='../images/$post_image' alt='image'></td>";
        ...
        echo "<td><a onClick=\" javascript: return confirm('Are you sure??'); \" href='posts.php?reset={$post_id}'>Reset the views</a></td>";
        echo "</tr>";
        } ?> 
    <?php 
        ...
        if(isset($_GET['delete'])){
            ...
            $query= "DELETE FROM posts WHERE post_id =" .mysqli_real_escape_string($connection,$$_GET['reset'])." {$the_post_id}";
        ...
        if(isset($_GET['reset'])){
            ...
            $query= "UPDATE posts SET post_views_count = 0 WHERE post_id =" .mysqli_real_escape_string($connection,$$_GET['reset'])." {$the_post_id}";
            $result = mysqli_query($connection , $query);
            header("Location: posts.php");
        }
    ?>
